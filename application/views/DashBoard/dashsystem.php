...
<html lang="en">
    <head>
        ...
        <script src="/js/history/history.js" language="javascript" type="text/javascript"></script>
        ...
        <script language="JavaScript" type="text/javascript">
            ...
            function onLoadComplete(){
                //alert("si");
                thisMovie("IFrameDemo").dataFlash();
                //document.getElementById("myIFrame").dataFlash()
                //document.getElementById("flash").SetVariable("externa",2);
            }
            /*
             *funcion llamada desde actionscript
             **/
            function flashSend(ruta,archivo,absRoute){
                //alert("ENTRA "+ruta+" "+archivo);
                window.frames.frameClave.flashSend(ruta,archivo,absRoute);
            }
            function flashSave(rutaAbs){
                window.frames.frameClave.flashSave(rutaAbs);
            }
            ...
            function loadIFrame(url){
                document.getElementById("myFrame").innerHTML = "<iframe id='myIFrame' src='" + url + "'frameborder='0' name='frameClave' width='100%' height='100%'></iframe>";
    ...
    <!-- <script language="JavaScript" type="text/javascript" src="history.js"></script> -->
        <script language="JavaScript" type="text/javascript">
            ...
            if ( hasProductInstall && !hasRequestedVersion ) {
                ...
                AC_FL_RunContent(
                "src", "/system/application/views/DashBoard/bin/nexus",
                "width", "100%",
                "height", "100%",
                "align", "middle",
                "id", "IFrameDemo",
        ...
        <noscript>
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                ...
                <param name="movie" value="/system/application/views/DashBoard/bin/nexus.swf" />
                <param name="quality" value="high" />
                <param name="bgcolor" value="#869ca7" />
                <param name="allowScriptAccess" value="sameDomain" />
                <embed src="/system/application/views/DashBoard/bin/nexus.swf" quality="high" bgcolor="#869ca7"
